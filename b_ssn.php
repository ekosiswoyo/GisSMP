...
var map;
   ...
   <?php
       ...
       mysqli_select_db($koneksi, $db);
            	...
            	$sql_lokasi="select b.id_sekolah,lat,lang, avg(skor_ssn) as jumlah from tb_sekolah a, tb_nilaissn b WHERE a.id_sekolah=b.id_sekolah group by b.id_sekolah HAVING AVG(skor_ssn) > 0 and AVG(skor_ssn) < 100";
