                        ...
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                  <?php
                                $n = 1;	
                                $sql=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT avg(skor_ssn) as total, nama_lokasi, nama_sekolah from tb_nilaissn a, tb_sekolah b, tb_standar c, tb_periode d, lokasi_lahan e where a.id_sekolah = b.id_sekolah and a.id_standar = c.id_standar and a.id_kecamatan = e.id and a.id_periode = d.id_periode group by a.id_kecamatan");
